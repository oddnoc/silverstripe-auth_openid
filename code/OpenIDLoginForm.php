...
class OpenIDLoginForm extends LoginForm {
	 ...
	 * @param bool    $checkCurrentUser (optional) If set to TRUE, it will be checked if a
	 */
		...
		if ( $checkCurrentUser && Member::currentUserID() ) {
			...
			if ( !$fields ) {
			  ...
			  '
					...
					new TextField(
						"OpenIDURL",
						_t( 'OpenIDLoginForm.URL', "OpenID URL" ),
	...
	protected function getMessageFromSession() {
		...
		if ( ( $member = Member::currentUser() ) && !Session::get('OpenIDLoginForm.force_message') ) {
